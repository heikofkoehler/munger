...
Equity Awards: A large concentrations in specific securities requires exposure tracking.
...
Calculate Concentration Risk: Specifically track and flag when securities exceeds user-defined thresholds.
